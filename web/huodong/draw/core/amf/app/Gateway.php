...
class Gateway {
	 ...
	 * @param string $handler Which service handler to use
	 */
	function regenerateMethodTable($value = true) {
		$GLOBALS['amfphp']['regenerateMethodTable'] = $value;
	} 
	 ...
	 *
	 */
	function setAmf3RecordSetFormat($format) {
		$GLOBALS['amfphp']['amf3RecordSetFormat'] = $format;
	}
