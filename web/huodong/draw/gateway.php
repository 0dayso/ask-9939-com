<?php
	...
	*/
	...
	//You can choose either Array or ArrayCollection here (Flex 2/Flash 9 AS3 only)
	...
	//This is new to AMFPHP 2.0: 
	//Set adapter mappings (kept in a third config file shared with JSON and XML-RPC
	//for convenience)
