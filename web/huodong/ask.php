		...
		success:function(data) {
			...
			if(data=='error-100') { //帐号重复
				...
				$.get('/ask/loadhtml/html/okhd/id/' + data, function(msg) {
					...
					var p=o.pwd;
					//var c=o.num;
					if($("input[name='register']:checked").val()==1) url = encodeURI("http://ask.9939.com/web/huodong/ask_reg_ok.php?n="+n+"&p="+p);			
					else url = encodeURI("http://ask.9939.com/web/huodong/ask_ok.php");
          	...
          	<div class="c lw-askProcessL">
          		...
          		<div class="bd">
          			<p class="vMarginLg bPaddingLg">
						...
						2：用户在提问的时候问题标题不能少于5个字，内容不得少于30字。用户不能重复提问，不能提无意义的问题。    
