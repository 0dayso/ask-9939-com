...
document.writeln("<p>数量:  <label><input type='text' name='gbooknum' id='gbooknum' size=5 /></label></p>");
document.writeln("<p>规格:  <label><input type='text' name='gbookprocode' id='gbookprocode' size=5 /></label></p><input type='hidden' name='idfkdiy' value='5' id='idfkdiy' />");
