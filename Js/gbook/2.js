...
document.writeln("<link href=\"http://www.78.cn/style/guestbook_style.css\" rel=\"stylesheet\" type=\"text/css\" />");
...
document.writeln("		   <p>价格:  <label><input type='text' name='gbookprice' id='gbookprice' size=5 /></label></p>");
document.writeln("<p>数量:  <label><input type='text' name='gbooknum' id='gbooknum' size=5 /></label></p><input type='hidden' name='idfkdiy' value='2' id='idfkdiy' />");
...
document.writeln("			<input type=\"hidden\" name=\"idggy\" id=\"idggy\">");
