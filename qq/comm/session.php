...
{
    //mysql的主机地址
    const db_host = "192.168.229.47"; //需要第三方指定ip地址 

    //数据库用户名
    const db_user = "9939_indata";   //需要第三方指定自己的用户名

    //数据库密码
    const db_pwd = "3edcVFR$"; //需要第三方指定自己的库据库密码

    //数据库
    const db_name = "9939_com_v2sns";      //需要第三方指定数据库

    //数据库表
    const db_table = "member"; //需要第三方指定数据表
 ...
 */
define("MAIN_DOMAIN", ".ask.9939.com");   //设置主域名
