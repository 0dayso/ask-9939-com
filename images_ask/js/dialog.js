;(function () {
	...
	boxDialog.prototype.init=function(html) {
		this.template='<div class="mod tmod-02"><span class="top"><span class="tl"></span><span class="tr"></span></span><div class="inner"></div><span class="bottom"></span></div>';
		this.element=$(this.template);
		this.html=html;
		this.element.css("display","none");
		this.element.appendTo(document.body);
	};
	boxDialog.prototype.show=function(template) {
...
var that=this;
	...
	compoDialog.prototype.show=function(template) {
		for (var i=0,j=this.compo.length; i < j; i++) {
			this.compo[i].show(template);
		};
	};
